#!/usr/bin/env python3
"""
Hugging Face Spaces deployment for the Humanoid Robotics RAG backend
"""
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://zoyaafzal.github.io"],  # In production, replace with specific origins
